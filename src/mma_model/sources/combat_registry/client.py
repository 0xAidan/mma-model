"""Combat Registry public HTTP snapshot client (DWCS-105).

Public/unauthenticated commission-or-result pages only. No login portal or API.
"""
...
class CombatRegistryPublicClient:
    """Thin wrapper around PoliteHttpClient for unauthenticated public pages."""
