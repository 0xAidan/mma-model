"""Tapology public adapter: fixtures/live orchestration (DWCS-105)."""
...
from mma_model.sources.tapology_public.client import BASE_HOST, TapologyPublicClient
from mma_model.sources.tapology_public.mapper import map_fighter_to_observations
from mma_model.sources.tapology_public.parser import SOURCE_TAPOLOGY_PUBLIC, parse_fighter_page

if TYPE_CHECKING:
    from mma_model.ingest.raw_store import ContentAddressedRawStore


class TapologyPublicAdapter:
    """Orchestrate Tapology fetch/parse/map without writing ORM tables."""

    def __init__(
        self,
        *,
        fixture_root: Path | None = None,
        client: TapologyPublicClient | None = None,
    ...
    def iter_fighter_observations(
        ...
        *,
        ...
        while page_id:
            ...
            url = f"https://www.{BASE_HOST}/fightcenter/fighters/{page_id}"
            try:
            ...
            if not next_url:
                break
            page_id = _fighter_id_from_url(str(next_url))
