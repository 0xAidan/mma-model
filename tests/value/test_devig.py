...
@pytest.mark.parametrize(
    ...
    [
        ...
        (MarketFamily.EXACT_ROUND, 5, None),
        (MarketFamily.TOTALS, None, 1.5),
        (MarketFamily.TOTALS, None, 2.5),
    ],
)
def test_all_families_complete_and_incomplete(
    family: MarketFamily,
...
def test_generic_api_requires_explicit_expected_keys() -> None:
...
def test_exact_round_requires_scheduled_rounds() -> None:
